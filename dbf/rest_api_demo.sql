...
('admin', MD5('1234'), 'admin@example.com', 'admin'),
('user1', MD5('1111'), 'user1@example.com', 'user'),
('user2', MD5('2222'), 'user2@example.com', 'user');

ALTER TABLE items MODIFY id INT AUTO_INCREMENT PRIMARY KEY;
